            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, cloudinary_config_1.uploader.upload(path_1.resolve(__dirname, "../../uploads/" + image.originalname), {
                                resource_type: 'image',
                    ...
                    case 1:
                        i = _a.sent();
                        if (i.secure_url) {
                            photos = __spreadArrays(photos, [{ imageURL: i.secure_url, name: fileName }]);
                            if (photos.length === images.length) {
                                request_1.Request.findByIdAndUpdate(reqId, {
                                    //@ts-ignore
                                    $set: { images: photos },
                                }).exec();
                                resolve('done');
