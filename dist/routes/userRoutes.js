...
userRouter.route('/test').get(express_async_handler_1.default(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var location, userId, radius;
    return __generator(this, function (_a) {
        location = { latitude: 28.7, longitude: 77.1 };
        userId = 'Rbs0iLel6';
        radius = 3;
        grpc_client_1.client.saveUserLocation({ userId: userId, location: location, radius: radius }, function (err, data) {
            if (err)
                throw err;
            console.log(data);
            res.json(data);
